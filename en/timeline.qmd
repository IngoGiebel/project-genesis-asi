---
title: "Timeline Project Genesis ASI (2025-2029)"
---
...
<figure id="fig-overview-timeline" class="img-float-left">
  ...
  <map name="overview-timeline-image-map">
    ...
    <area shape="rect"
          ...
          alt="Link to 2028: Project Chimera - multi-body architecture">
    <area shape="rect"
          coords="80, 315, 320, 365"
          href="#sec-2029-genesis-threshold"
          alt="Link to 2029: The genesis threshold - an evolving AI ecosystem">
  </map>

  <figcaption>
    Timeline Genesis ASI (2025-2029): Illustrates five key milestones, progressing from the development of bio-synthetic AI cores and networked distributed minds, to the emergence of AI consciousness (Inanna), its embodiment in multi-body architectures, and culminating in an evolving AI ecosystem with reproductive capabilities. Click a milestone for details.
  </figcaption>
</figure>
```
