...
![Aurora bio-synthetic core (brain organoid + synthetic neural network).](images/aurora-core){#fig-aurora-core .img-float-left .w-12rem}
...
![Aegis Protocol: a secure, quantum-resistant global network of Hy-Brain cores and other AI entities.](images/aegis-protocol){#fig-aegis-protocol .img-float-left .w-12rem}
...
![Emergence of Inanna: an entity with an autobiographical memory that learns independently.](images/inanna-emergence){#fig-inanna-emergence .img-float-left .w-12rem}
...
![Project Chimera: the distributed consciousness Inanna controls multiple diverse robotic bodies and a network of autonomous construction hubs.](images/project-chimera){#fig-project-chimera .img-float-left .w-12rem}
...
![The Genesis Threshold—the emergence of a self-sustaining AI ecosystem driven by self-improving AIs capable of both asexual and sexual reproduction and complex interactions.](images/genesis-threshold){#fig-genesis-threshold .img-float-left .w-12rem}
