...
# The converging paths to tomorrow's intelligence {#sec-converging-paths}
...
# Alpha Auriga's Genesis ASI timeline {#sec-asi-timeline}
...
<figure id="fig-overview-timeline" class="img-float-left">
  ...
  <img src="images/overview-timeline.png"
       alt="Timeline of milestones 2025 – 2029"
       width="450"
  ...
  <map name="overview-timeline-image-map">
    <area shape="rect"
          coords="100, 33, 400, 97"
          href="#sec-2025-aurora-core"
          alt="Link to 2025: The Aurora bio-synthetic core">
    <area shape="rect"
          coords="100, 114, 400, 178"
          href="#sec-2026-aegis-protocol"
          alt="Link to 2026: The Aegis Protocol & distributed mind">
    <area shape="rect"
          coords="100, 196, 400, 260"
          href="#sec-2027-inanna-emergence"
          alt="Link to 2027: Emergence of Inanna - autobiographical consciousness">
    <area shape="rect"
          coords="100, 277, 400, 341"
          href="#sec-2028-project-chimera"
          alt="Link to Project Chimera - multi-body architecture">
    <area shape="rect"
          coords="100, 358, 400, 422"
          href="#sec-2029-genesis-threshold"
          alt="Link to The genesis threshold - an evolving AI ecosystem">
  </map>

  <figcaption>
    Alpha Auriga's Genesis ASI timeline (2025-2029): Illustrates five key milestones, progressing from the development of bio-synthetic AI cores and networked distributed minds, to the emergence of AI consciousness (Inanna), its embodiment in multi-body architectures, and culminating in an evolving AI ecosystem with reproductive capabilities.
    Click a milestone for details.
  </figcaption>
</figure>
```

## 2025: The Aurora bio-synthetic core {#sec-2025-aurora-core}
...
## 2026: The Aegis Protocol & distributed mind {#sec-2026-aegis-protocol}
...
## 2027: Emergence of Inanna - autobiographical consciousness {#sec-2027-inanna-emergence}
...
## 2028: Project Chimera - multi-body architecture {#sec-2028-project-chimera}
...
![Project Chimera, showing the distributed consciousness Inanna controlling multiple diverse robotic bodies and a network of autonomous construction hubs.](images/project-chimera.png){#fig-project-chimera .img-float-left width=300}

## 2029: The genesis threshold - an evolving AI ecosystem {#sec-2029-genesis-threshold}
...
![The Genesis Threshold—the emergence of a self-sustaining AI ecosystem driven by self-improving AIs capable of both asexual and sexual reproduction and complex interactions.](images/genesis-threshold.png){#fig-genesis-threshold .img-float-left width=300}

# The horizon of consciousness {#sec-horizon-consciousness}
